...
--
-- Host: 127.0.0.1
-- Generation Time: May 03, 2021 at 11:47 AM
...
(10, 1, '2021-03-07', 3, 2021, 0, 0, 0, 0, 0, 0, 0, 'unpaid', '0'),
(11, 2, '2021-03-07', 3, 2021, 0, 0, 0, 0, 0, 0, 0, 'unpaid', '0'),
(12, 3, '2021-03-07', 3, 2021, 0, 0, 0, 0, 0, 0, 0, 'unpaid', '0'),
(13, 4, '2021-03-07', 3, 2021, 0, 0, 0, 0, 0, 0, 0, 'unpaid', '0'),
(14, 5, '2021-03-23', 3, 2021, 300, 0, 0, 0, 100, 200, 100, 'paid', '11'),
(15, 6, '2021-04-22', 4, 2021, 300, 0, 0, 0, 0, 0, 0, 'unpaid', NULL),
(16, 7, '2021-04-23', 4, 2021, 300, 0, 0, 0, 0, 0, 0, 'unpaid', NULL),
(17, 8, '2021-04-23', 4, 2021, 300, 0, 0, 0, 0, 0, 0, 'unpaid', NULL);
...
INSERT INTO `finance` (`id`, `datetime_`, `type`, `details`, `DR`, `CR`, `maad`, `sadaqa`) VALUES
(1, '2021-01-31 09:29:20', 'S', 'نتخواہ کی ادائیگی', 0, 5000, 'ا', NULL),
(2, '2021-02-02 00:15:00', 'D', 'ھکجھکج', 0, 0, 'ا', NULL),
(3, '2021-02-02 00:15:00', 'D', 'ھکجھکج', 5000, 0, 'ا', NULL),
(4, '2021-02-02 00:17:00', 'D', 'kjbhkj', 0, 2000, 'ا', NULL),
(6, '2021-02-09 11:17:00', 'D', 'kharcha', 0, 1000, 'ا', NULL),
(7, '2021-02-09 11:18:00', 'F', 'fees', 300, 0, 'ا', NULL),
(8, '2021-02-09 07:58:08', 'FF', 'فیس کی وصولی', 100, 0, 'ا', NULL),
(9, '2021-02-09 12:02:00', 'F', 'مسرور', 1000, 0, 'ا', NULL),
(10, '2021-03-07 17:38:00', 'F', 'فیس وصول کی جاچکی ہے۔', 100, 0, 'ا', NULL),
(11, '2021-03-23 09:20:05', 'FF', 'فیس کی وصولی', 100, 0, 'اا', NULL),
(12, '2021-05-03 14:32:00', 'D', 'چندہ برئے ارسلان', 5000, 0, 'ا', 0),
(13, '2021-05-03 14:35:00', 'D', 'چندہ برئے ارسلان', 5000, 0, 'ارسلان', 0),
(14, '2021-05-03 14:36:00', 'D', 'چندہ برائے ارسلان', 5000, 0, 'ارسلان', 0);
...
--
-- Table structure for table `roll_number`
--
...
--
-- Dumping data for table `roll_number`
--

INSERT INTO `roll_number` (`id`, `GR_no`, `roll_no`) VALUES
(1, 7, 3),
(2, 8, 1);
...
INSERT INTO `students` (`GR_no`, `student_name`, `gender_g`, `disability`, `father_name`, `sir_name`, `date_of_birth`, `date_of_admission`, `monthly_fees`, `complete_address`, `CNIC`, `contact_office`, `contact_home`, `qualification`, `last_school_name`, `last_school_address`, `reason_for_leave_school`, `class`, `department`, `occupation`, `time_for_study`, `image_name`, `discount`, `class_type`) VALUES
(1, 'محمد اویس', 'لڑکا', 'کوئی نہیں', 'محمد رفیق', 'رحمانی', '2021-01-26', '2021-01-26', 300, 'تاج مسجد گولیمار نوابشاہ', '4540266207031', '03058214945', '0', 'کوئی نہیں', 'کوئی نہیں', 'کوئی نہیں', 'کوئی نہیں', 'ابتدائیہ', 'حافظ', 'کاروبار', 'بعد از فجر', '1.jpeg', 50, 'د'),
(2, 'محمد ارسلان', 'لڑکا', 'کوئی نہیں', 'محمد افضل', 'آرائیں', '2021-01-26', '2021-01-26', 300, 'تاج مسجد گولیمار نوابشاہ', '4540266207031', '03058214945', '0', 'کوئی نہیں', 'کوئی نہیں', 'کوئی نہیں', 'کوئی نہیں', 'اول', 'حافظ', 'کاروبار', 'بعد از فجر', '2.jpg', 0, 'ج'),
(3, 'محمد ارسلان', 'لڑکا', 'کوئی نہیں', 'محمد افضل', 'رحمانی', '2021-01-27', '2021-01-27', 300, 'تاج مسجد گولیمار نوابشاہ', '4540266207031', '03009808899', '0', 'کوئی نہیں', 'کوئی نہیں', 'کوئی نہیں', 'کوئی نہیں', 'اول', 'حافظ', 'کاروبار', 'بعد از فجر', '3.jpg', 0, NULL),
(4, 'زین العابدین فیض', 'لڑکا', 'کوئی نہیں', 'قاری عبداللہ فیض', 'مغل', '2015-02-25', '2021-02-09', 300, 'نزد ختم نبوت چوک تاج اعظم کالونی نواب شاہ', '4540208881247', '03009808899', '03219808899', 'کوئی نہیں', 'کوئی نہیں', 'کوئی نہیں', 'کوئی نہیں', 'اول', 'ناظرہ بنین', 'درس و تدریس', 'بعد از مغرب', '4.jpg', 100, 'ب'),
(5, 'عائشہ', 'لڑکی', 'کوئی نہیں', 'قاری حفیظ اللہ', 'عباسی', '2016-12-30', '2021-02-09', 300, 'نزد تاج مسجد کمالہ کالونی نواب شاہ', '4540266207031', '03335486998', '03153738899', 'کوئی نہیں', 'کوئی نہیں', 'کوئی نہیں', 'کوئی نہیں', 'چہارم', 'ناظرہ بنات', 'درس و تدریس', 'بعد از فجر', '5.jpg', 200, 'ج'),
(6, 'محمد اویس', 'لڑکا', 'کوئی نہیں', 'محمد رفیق', 'رحمانی', '2021-04-22', '2021-04-22', 300, 'نوابشاہ', '4540266207031', '03058214945', '0', 'کوئی نہیں', 'کوئی نہیں', 'کوئی نہیں', 'کوئی نہیں', 'اول', 'حافظ', 'کاروبار', 'بعد از عشاء', '6.jpg', 0, 'ب'),
(7, 'محمد اویس', 'لڑکا', 'کوئی نہیں', 'محمد رفیق', 'رحمانی', '2021-04-23', '2021-04-23', 300, 'نوابشاہ', '4540266207031', '03058214945', '0', 'کوئی نہیں', 'کوئی نہیں', 'کوئی نہیں', 'کوئی نہیں', 'اول', 'حافظ', 'کاروبار', 'بعد از مغرب', '7.jpg', 0, 'الف'),
(8, 'Muhammad Owais', 'لڑکا', 'کوئی نہیں', 'Muhammad Rafique', 'Rehmani', '2021-04-23', '2021-04-23', 300, 'Near Taj Masjid Golimar', '4540266207031', '03058214945', '0', 'کوئی نہیں', 'کوئی نہیں', 'کوئی نہیں', 'کوئی نہیں', 'ابتدائیہ', 'Hafiz e Quran', 'IT Professional', 'بعد از فجر', '8.png', 0, 'الف');
...
--
-- Indexes for table `roll_number`
--
ALTER TABLE `roll_number`
  ADD PRIMARY KEY (`id`),
  ADD KEY `GR_no` (`GR_no`);
...
--
-- AUTO_INCREMENT for table `roll_number`
--
ALTER TABLE `roll_number`
...
--
ALTER TABLE `students`
  MODIFY `GR_no` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
-- Constraints for table `roll_number`
--
ALTER TABLE `roll_number`
  ADD CONSTRAINT `roll_number_ibfk_1` FOREIGN KEY (`GR_no`) REFERENCES `students` (`GR_no`);
